...
public class symbol_list {
     ...
     */
    public static double expression(symbol_list symbols) {
     ...
     */
    public static double plusminus(symbol_list symbols) {
     ...
     * @return calculation of an expression between adjacent numbers according to the symbol between them
     */
    public static double multdiv(symbol_list symbols) {
     ...
     * @return calculation of an expression between adjacent numbers according to the symbol between them
     */
    public static double factor(symbol_list symbols) {
        symbol token = symbols.next();
        switch (token.type) {
            case NUMBER:
